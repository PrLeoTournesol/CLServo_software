...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOA, INLINE_B_Pin|INLINE_A_Pin|PVDDSENSE_Pin|INH_C_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB13     ------> ADC3_IN5
    */
    HAL_GPIO_DeInit(GPIOB, ASENSE_V_Pin|BSENSE_V_Pin|CSENSE_V_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB14     ------> ADC4_IN4
    */
    HAL_GPIO_DeInit(GPIOB, S02_Pin|S01_Pin);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC_MspDeInit 0 */
    ...
    PA5     ------> DAC_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, VREF_Pin|PROTEC_REF_Pin);
